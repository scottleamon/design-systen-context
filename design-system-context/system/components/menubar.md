...
- **Related Components:** [Dropdown Menu](./dropdown-menu.md) (single dropdown), [Context Menu](./context-menu.md) (right-click menu)
- **Accessibility:** [Navigation Accessibility](../a11y/navigation.md) — Menu ARIA patterns
- **Patterns:** [Component Match](../patterns/component-match.md) — Menu component selection

...
- **Related Components:** [Input](./input.md) (text input alternative), [Form](./form.md) (form integration)
- **Accessibility:** [Forms Accessibility](../a11y/forms.md) — Slider ARIA patterns

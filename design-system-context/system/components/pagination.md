...
- **Related Components:** [Data Table](./data-table.md) (table pagination), [Button](./button.md) (page buttons)
- **Accessibility:** [Navigation Accessibility](../a11y/navigation.md) — Pagination ARIA patterns

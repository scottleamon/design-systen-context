...
|------|--------|-------------|
| [color-system.md](./color-system.md) | 🔴 Needs Human Input | Why these specific colors for each theme |
| [token-scale.md](./token-scale.md) | 🔴 Needs Human Input | Why the spacing/sizing scale choices |
| [component-library.md](./component-library.md) | 🔴 Needs Human Input | Why shadcn/ui and Radix |
| [typography.md](./typography.md) | 🔴 Needs Human Input | Why Adelle Sans font family |
| [multi-theme.md](./multi-theme.md) | 🔴 Needs Human Input | Why 3 themes, why these specific properties |

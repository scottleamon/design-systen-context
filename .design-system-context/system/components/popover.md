...
- **Related Components:** [Tooltip](./tooltip.md) (hover-only info), [Dialog](./dialog.md) (larger overlay), [Hover Card](./hover-card.md) (hover variant)
- **Accessibility:** [Dialog Accessibility](../a11y/dialogs.md) — Popover focus management

...
- **Related Components:** [Toggle Group](./toggle-group.md) (grouped toggles), [Button](./button.md) (non-toggle action)
- **Accessibility:** [Navigation Accessibility](../a11y/navigation.md) — Toggle ARIA patterns

...
- **Related Components:** [Calendar](./calendar.md) (date selection), [Form](./form.md) (form integration), [Popover](./popover.md) (container)
- **Accessibility:** [Forms Accessibility](../a11y/forms.md) — Date input ARIA patterns

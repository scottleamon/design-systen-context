...
- **Related Components:** [Combobox](./combobox.md) (with search), [Form](./form.md) (form integration), [Radio Group](./radio-group.md) (inline alternative)
- **Accessibility:** [Forms Accessibility](../a11y/forms.md) — Select ARIA patterns
